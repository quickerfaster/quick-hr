@php
    ...
    $resolver = app(ConfigResolver::class, ['configKey' => "admin.company"]);
...
<x-qf::navigation-layout configKey="admin.company" context="Company Profile" moduleName="admin" :overrides="[
    ...
    @livewire($customComponent, ["inline" => true, "recordId" => $recordId, "configKey" => "admin.company", "returnParams" => $returnParams])
