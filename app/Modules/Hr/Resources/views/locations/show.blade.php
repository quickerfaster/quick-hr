@php
    ...
    $resolver = app(ConfigResolver::class, ['configKey' => "hr.location"]);
...
<x-qf::navigation-layout configKey="hr.location" context="Company Profile" moduleName="hr" :overrides="[
    ...
    @livewire($customComponent, ["inline" => true, "recordId" => $recordId, "configKey" => "hr.location", "returnParams" => $returnParams])
